...
then
    ...
    #SAP example
    #ant createPlatformImageStructure -DexternalTomcatDir=/Users/ixxx/dockerPOC/apache-tomcat-8.0.38 -DplatformImageAspects=/Users/ixxx/dockerPOC/aspectsmap.properties
    ...
    ## Docker 
    #aws s3 cp s3://$SCRIPTS3BUCKET/$SCRIPTKEYPREFIX/Dockerfile $HYBRISDIR/
    #aws s3 cp s3://$SCRIPTS3BUCKET/$SCRIPTKEYPREFIX/local.properties $HYBRISDIR/
    #aws s3 cp s3://$SCRIPTS3BUCKET/$SCRIPTKEYPREFIX/startup.sh $HYBRISDIR/
    #cp $HYBRISDIR/startup.sh . 
    #cp $HYBRISDIR/Dockerfile . 
    #cp $HYBRISDIR/local.properties /usr/sap/hybris/config/
